...
public class Validators {
	...
	public static String validateAccountIds(String fromAccountId,String toAccountId,AccountsService accountsService) {
		...
		if (fromAccountId == null || fromAccountId.equals("") || accountsService.getAccount(fromAccountId) == null) {
			return "Invalid accountId "+ fromAccountId;
		}
		
		if (toAccountId == null || toAccountId.equals("") || accountsService.getAccount(fromAccountId) == null) {
